## {{{ http://code.activestate.com/recipes/576858/ (r1)
#!/user/bin/env python
...
if __name__ == "__main__":
    # Run some tests
    mFrom = "William Chang <weipanchang@comcast.net>"
    mTo = "weipanchang@yahoo.com"
    m = Email('smtp.comcast.net:587')
    #email_server=smtplib.SMTP('smtp.comcast.net', 587)
    #m._smtpServer = smtplib.SMTP('smtp.comcast.net', 587)
    #LOGIN='weipanchang@comcast.net'
    #PASSWORD='nov18168'
    #m._smtpServer.set_debuglevel(1)
    #m._smtpServer.ehlo()
    #m._smtpServer.starttls()
    #m._smtpServer.login(LOGIN, PASSWORD)
    m.setFrom(mFrom)
    m.addRecipient(mTo)
    ...
    m.addAttachment("allen.jpg")
    m.send()
## end of http://code.activestate.com/recipes/576858/ }}}
